...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # TODO: channel, gw, gd
            ...
            c2 = ch[f] // args[0] ** 2
        elif m is RadDenseNet121Backbone: # add handling for RadImageNet DenseNet121 backbone
            c2 = [args[1], args[1], args[1]]
        elif m is ImageNetDenseNet121Backbone: # add handling for ImageNet DenseNet121 backbone
            c2 = [args[1], args[1], args[1]]
        elif m is SelectFeature: # add handling for SelectFeature module
            index = args[0]
            c2 = args[1]
            args = [index]
        else:
